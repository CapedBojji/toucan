...
> **entity**(`label?`): [`EntityHandle`](/toucan/api/core_ecs/entityhandle/)

Defined in: [src/handle.ts:477](https://github.com/OverlineJunior/toucan/blob/master/src/handle.ts#L477)
